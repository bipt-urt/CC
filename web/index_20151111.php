...
<html lang="zh-cn">
	<head>
		...
		<style>#view_res{font-family: 方正等线,方正细等线,微软雅黑,苹方,黑体}</style>
        <style>#view_code{font-family: 方正等线,方正细等线,微软雅黑,苹方,黑体}</style>
	...
	<body>
    	...
    	<div class="container-fluid">
			...
			<div class="row">
				...
				<?php endif; ?>
                <h2 id="view_code">编辑您的代码：</h2>
						<textarea class="form-control dengkuan" rows="20" name="test_1"><?php echo $_POST["test_1"];?></textarea>
